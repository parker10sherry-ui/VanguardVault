const PLAYERS = {
    "S. Sanders":    { full: "Shedeur Sanders",      team: "Cleveland Browns" },
    "J. Dart":       { full: "Jaxson Dart",           team: "New York Giants" },
    "C. Ward":       { full: "Cam Ward",              team: "Tennessee Titans" },
    "T. Shough":     { full: "Tyler Shough",          team: "New Orleans Saints" },
    "D. Gabriel":    { full: "Dillon Gabriel",        team: "Cleveland Browns" },
    "W. Howard":     { full: "Will Howard",           team: "Pittsburgh Steelers" },
    "T. Warren":     { full: "Tyler Warren",          team: "Indianapolis Colts" },
    "C. Loveland":   { full: "Colston Loveland",      team: "Chicago Bears" },
    "T. McMillan":   { full: "Tetairoa McMillan",     team: "Carolina Panthers" },
    "E. Ayomanor":   { full: "Elic Ayomanor",         team: "Tennessee Titans" },
    "E. Egbuka":     { full: "Emeka Egbuka",          team: "Tampa Bay Buccaneers" },
    "J. Higgens":    { full: "Jayden Higgins",        team: "Houston Texans" },
    "C. Skattebo":   { full: "Cameron Skattebo",      team: "New York Giants" },
    "T. Henderson":  { full: "TreVeyon Henderson",    team: "New England Patriots" },
    "A. Jeanty":     { full: "Ashton Jeanty",         team: "Las Vegas Raiders" },
    "Q. Judkins":    { full: "Quinshon Judkins",      team: "Cleveland Browns" },
    "O. Hampton":    { full: "Omarion Hampton",       team: "Los Angeles Chargers" },
    "K. Johnson":    { full: "Kaleb Johnson",         team: "Pittsburgh Steelers" },
    "O. Gordon II":  { full: "Ollie Gordon II",       team: "Miami Dolphins" },
    "JSN":           { full: "Jaxon Smith-Njigba",    team: "Seattle Seahawks" },
    "G. Wilson":     { full: "Garrett Wilson",        team: "New York Jets" },
    "J. Andreeson":  { full: "J. Andreeson",          team: "Unknown" },
    "J. Chase":      { full: "Ja'Marr Chase",         team: "Cincinnati Bengals" },
    "T. Kelce":      { full: "Travis Kelce",          team: "Kansas City Chiefs" },
    "M. Brown":      { full: "Marquise Brown",        team: "Kansas City Chiefs" },
    "J. Reed":       { full: "Jayden Reed",           team: "Green Bay Packers" },
    "JJ Watt":       { full: "J.J. Watt",             team: "Arizona Cardinals (Retired)" },
    "P. Mahones":    { full: "Patrick Mahomes",       team: "Kansas City Chiefs" },
    "A. Highsmith":  { full: "Alex Highsmith",        team: "Pittsburgh Steelers" },
    "J. Hurts":      { full: "Jalen Hurts",           team: "Philadelphia Eagles" },
    "J. Allen":      { full: "Josh Allen",            team: "Buffalo Bills" },
    "D. Maye":       { full: "Drake Maye",            team: "New England Patriots" },
    "JJ McCarthy":   { full: "J.J. McCarthy",         team: "Minnesota Vikings" },
    "M. Penix Jr.":  { full: "Michael Penix Jr.",     team: "Atlanta Falcons" },
    "Bo Nix":        { full: "Bo Nix",                team: "Denver Broncos" },
    "C. Williams":   { full: "Caleb Williams",        team: "Chicago Bears" },
    "J. Burrow":     { full: "Joe Burrow",            team: "Cincinnati Bengals" },
    "J. Herbert":    { full: "Justin Herbert",        team: "Los Angeles Chargers" },
    "J. Love":       { full: "Jordan Love",           team: "Green Bay Packers" },
    "B. Robinson":   { full: "Bijan Robinson",        team: "Atlanta Falcons" },
    "M. Harrison Jr.": { full: "Marvin Harrison Jr.", team: "Arizona Cardinals" },
    "M. Nabors":     { full: "Malik Nabers",          team: "New York Giants" },
    "B. Bowers":     { full: "Brock Bowers",          team: "Las Vegas Raiders" },
    "R. Odunze":     { full: "Rome Odunze",           team: "Chicago Bears" },
    "R. Pearsall":   { full: "Ricky Pearsall",        team: "San Francisco 49ers" },
    "T. Franklin":   { full: "Troy Franklin",         team: "Denver Broncos" },
    "X. Worthy":     { full: "Xavier Worthy",         team: "Kansas City Chiefs" },
};

// Player photo URLs (NFL headshots from public sources)
function getPlayerImage(shortName) {
    const p = PLAYERS[shortName];
    if (!p) return "";
    // Use ui-avatars as a reliable fallback with player initials
    const name = encodeURIComponent(p.full);
    return `https://ui-avatars.com/api/?name=${name}&background=1e293b&color=d4a843&size=120&bold=true&font-size=0.4`;
}
